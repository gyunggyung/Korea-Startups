...
## Contents
- [**ROA Intelligence**](https://stage.roa.ai/): 자연어 처리 기술을 기반으로 **기업 분석 및 검색** 서비스 개발. 17년된 컨설팅 회사가 모회사로 존재하여, 다양한 데이터가 존재. 이사진이 모두 창업가 출신으로 아이템에 대한 이해가가 높으며, 주장이 합리적이면 받아들이는 직원들에게 매우 열려있는 회사.
